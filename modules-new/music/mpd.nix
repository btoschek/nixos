  ...
  flake.homeModules.music = {pkgs, ...}: {
    ...
    home.file."./.config/rmpc/themes/custom.ron".text = ''
      ...
      (
        ...
        tab_bar: (
          enabled: true,
          active_style: (fg: "#${background}", bg: "blue", modifiers: "Bold"),
          inactive_style: (fg: "dark_gray", bg: "#${background}"),
        ),
        ...
        progress_bar: (
          ...
          thumb_style: (fg: "blue", bg: "dark_gray"),
        ),
    ...
    services.mpd = {
      ...
      musicDirectory = "$HOME/Music"; # "${config.home.homeDirectory}/Music";
